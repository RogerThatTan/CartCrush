    ...
    public partial class Payment : Form
    {
       ...
       public static string e = "";
        ...
        public void invoice()
        {
            ...
            string path = "C://C# Project//Project//Invoice" + Uname + Product.sendinvoice+".pdf";
       ...
       public void sendemail() 
        {
            ...
            string filename = "C://C# Project//Project//Invoice" + Login.loginusername + Product.sendinvoice+".pdf";
        ...
        public void sendemail2()
        {
            ...
            message.Body = messageBody;
            message.Subject = "Order Confirmation ";
            string filename = "C:\\C# Project\\Project\\Invoice" + Login.loginusername + ".pdf";
        ...
        private void proceed2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        string Uname = Login.loginusername;
                        string path = "C:\\C# Project\\Project\\Invoice" + Uname + ".pdf";
                        //string imagepath = @"D://OneDrive - American International University-Bangladesh//C#//Project//Images//signup-icon.png";
                        //iText.Layout.Element.Image logo = new iText.Layout.Element.Image(ImageDataFactory.Create(imagepath));
                        //logo.SetHeight(40);
                        // logo.SetWidth(30);
